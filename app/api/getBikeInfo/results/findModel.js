 ...
 */
function findModel(listing, models, searchIndices) {

  let bestMatch = null;
  let modelSearched = null;
  let extractedModel = null;

  for (const model of models) {

    let modelMatch = null;
    let modelMatchIndices = null;
    ...
    //     console.log(`MODEL SEARCHED: ${modelSearched} \n bestMatch:`, bestMatch);
    // }

    
  }

  return extractedModel ? extractedModel : null;
